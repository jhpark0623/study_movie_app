    ...
    <div className="youtube">
      ...
      <div className="yt__top_2">
        ...
        <div className="yt__top_2_right">
          ...
          <span className="yt__top_2_right_profile">종훈</span>
        </div>
      </div>
      ...
      <div className="yt__top_3">
        ...
        <div className="yt__top_3_classification">
          <span className="yt__top_3_classification_button yt__top_3_classification_button_all">
            전체
          </span>
          <span className="yt__top_3_classification_button yt__top_3_classification_button_new">
            새로운 맞춤 동영상
          </span>
          <span className="yt__top_3_classification_button">실시간</span>
          <span className="yt__top_3_classification_button">음악</span>
        </div>
      </div>
    </div>
  );
