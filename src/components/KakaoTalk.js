function KakaoTalk() {
  return (
    <div className="border-black border-2 bg-white p-5 max-w-[1000px]  relative">
      {/* 상단바 */}
      ...
      <div className="flex space-x-5 items-center mb-7">
        ...
        <div className=" flex space-x-3 items-center absolute right-6">
          <div className="border-2 border-gray-300 flex justify-center rounded-full text-xl w-[70px] h-[45px] items-center">
            MY
          </div>
          <div className="border-2 border-gray-300 flex justify-center rounded-full text-xl w-[80px] h-[45px] items-center">
            🐱‍🐉10
          </div>
        </div>
      </div>
      ...
      {/* pay */}
      <div className=" flex items-center p-4 bg-gray-200 rounded-lg justify-between">
        {/* pay */}
        <div className="flex items-center justify-center space-x-3 bg-white px-3 py-1 rounded-full w-36">
